...
static void wifi_scan(void)
{
    ...
    ESP_ERROR_CHECK(esp_event_handler_register(WIFI_EVENT, ESP_EVENT_ANY_ID, &on, NULL));
    ESP_ERROR_CHECK(esp_event_handler_register(IP_EVENT, IP_EVENT_STA_GOT_IP, &on, NULL));
    ...
    ESP_ERROR_CHECK(esp_wifi_scan_start(&sconfig, 0));
}
